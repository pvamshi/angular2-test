System.register(["angular2/core", "./Example.service"], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            TestComponent = (function () {
                function TestComponent(exampleService) {
                    this.testValue = 'test value';
                    this.vals = exampleService.getTitles();
                }
                TestComponent = __decorate([
                    core_1.Component({
                        selector: 'test',
                        template: "{{testValue}}\n              <ul>\n                <li *ngFor=\"#val of vals\">{{val}}<li>\n              </ul>",
